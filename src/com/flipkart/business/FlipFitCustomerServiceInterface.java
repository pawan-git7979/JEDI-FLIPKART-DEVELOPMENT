...
public interface FlipFitCustomerServiceInterface {
    ...
    /**
     * Method for viewing a customer's past bookings.
     * Displays all the bookings made by the customer.
     *
    ...
    /**
     * Method for viewing the payment history of the customer.
     * Displays all the payment records associated with the customer's account.
     *
     * @param userId The ID of the customer whose payments are to be viewed.
     */
